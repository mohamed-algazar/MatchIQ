        ...
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl">
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-3xl font-bold text-white mb-2 underline underline-offset-8 decoration-green-500/30">Welcome Back</h1>
                    <p className="text-slate-400">Sign in to your AI Football Analytics account</p>
                </div>
